...
const ageAbove18 = ((itemInList) => {
    return itemInList.age > 18;
})

let peopleAbove18 = people.filter(ageAbove18);
...
let coffeeLoverProperty = people.map(addCoffeeLoverProperty);
console.log(`CoffeeLoverProperty:`);
console.log(coffeeLoverProperty);

const coffeeLover = (person) => {
    if (person.coffeeLover === true) {
        return person.name;
    }
}
